...
import { User, Lock, Bell, Shield, Database, Trash2, Save, Eye, EyeOff } from 'lucide-react';
...
const SettingsTab: React.FC<SettingsTabProps> = ({ username, onUpdateSuccess }) => {
    const [activeSection, setActiveSection] = useState<'profile' | 'security' | 'notifications' | 'data'>('profile');
