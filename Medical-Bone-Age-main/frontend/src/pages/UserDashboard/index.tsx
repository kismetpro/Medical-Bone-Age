...
export default function UserDashboard() {
    ...
    const [activeTab, setActiveTab] = useState<'message' | 'predict' | 'history' | 'community' | 'consultation' | 'joint-grade' | 'settings' | 'preprocessing' | 'formula' | 'manual-grade'>('predict');
...
return (
    <div className={styles.dashboardLayout}>
        ...
        <UserSidebar 
            activeTab={activeTab} 
            setActiveTab={(tab:'message' | 'predict' | 'history' | 'community' | 'consultation' | 'joint-grade' | 'settings' | 'preprocessing' | 'formula' | 'manual-grade') => {
                if (tab !== activeTab) {
